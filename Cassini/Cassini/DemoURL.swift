...
struct DemoURL {
    ...
    struct NASA {
        ...
        static let Cassini = NSURL(string: "https://comm.stanford.edu/wp-content/uploads/2013/01/stanford-campus.png")
...
//        static let Saturn = NSURL(string: "https://www.nasa.gov/sites/default/files/saturn_collage.jpg")
        static let Earth = NSURL(string: "https://comm.stanford.edu/wp-content/uploads/2013/01/stanford-campus.png")
        static let Saturn = NSURL(string: "https://comm.stanford.edu/wp-content/uploads/2013/01/stanford-campus.png")
    }
}
